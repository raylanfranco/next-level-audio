            ...
            <div className="bg-black border-2 border-[#E01020]/30 p-8 md:p-12 neon-border-soft">
              ...
              {submitStatus === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-[#E01020] font-mono text-sm mb-2 uppercase">
                      {t('nameLabel')}
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-4 py-3 bg-black border-2 border-[#E01020]/30 text-[#E01020] placeholder-[#E01020]/40 font-mono focus:outline-none focus:border-[#E01020] transition-colors"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="email" className="block text-[#E01020] font-mono text-sm mb-2 uppercase">
                        {t('emailLabel')}
                      </label>
                      <input
                        type="email"
                    ...
                    <div>
                      <label htmlFor="phone" className="block text-[#E01020] font-mono text-sm mb-2 uppercase">
                        {t('phoneLabel')}
                      </label>
                      <input
                        type="tel"
                  ...
                  <div>
                    <label htmlFor="service" className="block text-[#E01020] font-mono text-sm mb-2 uppercase">
                      {t('serviceLabel')}
                    </label>
                    <select
                      id="service"
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-black border-2 border-[#E01020]/30 text-[#E01020] font-mono focus:outline-none focus:border-[#E01020] transition-colors"
                    >
                      <option value="">{t('selectService')}</option>
                      <option value="window-tinting">{t('windowTinting')}</option>
                      <option value="car-audio">{t('carAudio')}</option>
                      <option value="remote-start">{t('remoteStart')}</option>
                      <option value="security">{t('securitySystems')}</option>
                      <option value="lighting">{t('customLighting')}</option>
                      <option value="accessories">{t('autoAccessories')}</option>
                      <option value="other">{t('other')}</option>
                    </select>
                  </div>

                  <div>
                    <label htmlFor="message" className="block text-[#E01020] font-mono text-sm mb-2 uppercase">
                      {t('messageLabel')}
                    </label>
                    <textarea
                      id="message"
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-3 bg-black border-2 border-[#E01020]/30 text-[#E01020] placeholder-[#E01020]/40 font-mono focus:outline-none focus:border-[#E01020] transition-colors resize-none"
            ...
            <div className="space-y-8">
              ...
              <div className="bg-black border-2 border-[#E01020]/30 p-8 neon-border-soft">
                <div className="flex items-start gap-4">
                  <div className="text-[#E01020] neon-glow-soft">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center text-[#E01020] hover:text-[#FF2A3A] font-mono text-sm mt-3 transition-colors"
                    >
                      {tc('getDirections')}
                  ...
                  <div>
                    ...
                    <ul className="text-white/70 font-mono space-y-1">
                      <li className="flex justify-between">
                        <span>{t('monFri')}</span>
                        <span className="text-[#E01020]">{t('monFriHours')}</span>
                      </li>
                      <li className="flex justify-between">
                        <span>{t('saturday')}</span>
                        <span className="text-[#E01020]">{t('saturdayHours')}</span>
                      </li>
                      <li className="flex justify-between">
                        <span>{t('sunday')}</span>
