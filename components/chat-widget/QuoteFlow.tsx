  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hide p-4 flex flex-col">
      ...
      {step === 'select-service' && (
        <div className="flex-1 flex flex-col">
              ...
              <button
                ...
                className={`w-full text-left px-3 py-2.5 text-sm border transition-all cursor-pointer ${
                  form.service === s.label
                    ...
                    : 'border-[#E01020]/15 bg-[#0a0a0a] text-white/70 hover:border-[#E01020]/40'
                } font-oxanium`}
              >
                {s.label}
              </button>
          ...
          <button
            ...
            className="mt-4 w-full py-2.5 bg-[#E01020] text-black text-sm font-bold tracking-wider disabled:opacity-30 disabled:cursor-not-allowed hover:bg-[#E01020]/90 transition-colors cursor-pointer font-oxanium"
          >
            NEXT
          </button>
        </div>
      ...
      {step === 'customer-info' && (
        <div className="flex-1 flex flex-col">
          {/* Summary */}
          <div className="border border-[#E01020]/15 bg-[#E01020]/5 px-3 py-2 mb-4 text-xs font-mono text-white/60">
